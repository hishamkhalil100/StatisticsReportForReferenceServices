<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="PhotocopyStat.aspx.cs" Inherits="Admin_PhotocopyStat" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        ...
        function printdiv(printpage) {
            var headstr = "<html><head><title></title></head><body><div style=\"margin:0 auto;\"><h1 style=\"text-align:center;\"><img src=\"img/KFNLLOGO.png\"/></h1><br /><br /><br /><h1 style=\"text-align:center;\">التصوير</h1>";
            var fromToDate = "";
                    ...
                    <div id="div_print">
                        <table class="table table-striped table-bordered table-advance table-hover textTable">
                            ...
                            <tr>
                                    ...
                                    <th class="borderLeft"><i class="fa fa-file"></i>&nbsp;عدد الكتب </th>
                                    <th class="borderLeft"><i class="fa fa-file"></i>&nbsp;عدد الصفحات </th>
                                    <th class="borderLeft"><i class="fa fa-window-maximize"></i>&nbsp;عدد المستفدين</th>
