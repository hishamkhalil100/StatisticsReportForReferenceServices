        ...
        $('#form_wizard_1').bootstrapWizard({
            ...
            onNext: function (tab, navigation, index) {
                ...
                if (!$('#ContentPlaceHolder1_txtUserName').val()) {
                    ...
                    $('#ContentPlaceHolder1_rfvtxtUserName').css({ "visibility": "visible" });
                    $('#ContentPlaceHolder1_txtUserName').focus();
                    return false;
                }
                if (!$('#ContentPlaceHolder1_txtSearch').val()) {

                    $('#ContentPlaceHolder1_rfvtxtSearch').css({ "visibility": "visible" });
                ...
                if (current == 3) {
                    if (!$('#ContentPlaceHolder1_popupDatepicker').val()) {
                        $('#ContentPlaceHolder1_rfvpopupDatepicker').css({ "visibility": "visible" });
                        $('#ContentPlaceHolder1_popupDatepicker').focus();
                        return false;
                    }
                    var start = new Date($('#ContentPlaceHolder1_popupDatepicker').val());
                    var end = new Date($ ('#ContentPlaceHolder1_popupDatepickerEnd').val())
                    if (end < start)
                    {

                        $('#lblDateError').css({ "visibility": "visible" });
                        $('#ContentPlaceHolder1_popupDatepickerEnd').focus();
                        return false;
                    }
                }
                if (current >= total) {
...
//        from: 480, to: 1020, step: 15, dimension: '', scale: ['8:00', '9:00', '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00'], limits: false, skin: "round_plastic", calculate: function (value) {
