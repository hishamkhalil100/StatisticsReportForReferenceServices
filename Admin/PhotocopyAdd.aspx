<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="PhotocopyAdd.aspx.cs" Inherits="Admin_PhotocopyAdd" %>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab2">
                                        ...
                                        <%--<div class="control-group">
                                         ...
                                         <div class="control-group">
                                            <label class="control-label">عدد الكتب  *</label>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span6" id="txtNoOfPages" runat="server" name="txtNoOfBooks" />
                                                <asp:RequiredFieldValidator ID="rfvtxtNoOfPages" runat="server" ErrorMessage="يجب ادخال عدد الكتب المستخرجة " ControlToValidate="txtNoOfPages" ValidationGroup="AddGroup"></asp:RequiredFieldValidator>
