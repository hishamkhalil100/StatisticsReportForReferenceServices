<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="BooksFromIndexAdd.aspx.cs" Inherits="Admin_BooksFromIndexAdd" %>
                            ...
                            <div class="form-wizard">
                                ...
                                <div class="content">
                                    ...
                                    <div class="pane" >
                                        ...
                                        <div class="control-group">
                                            <label class="control-label">عدد النسخ  *</label>
                                            <div class="controls">
                                                <input type="text" class="span6" id="txtCopies" runat="server" name="txtReindex" />
                                                <asp:RequiredFieldValidator ID="rfvtxtCopies" runat="server" ErrorMessage="يجب ادخال عدد النسخ" ControlToValidate="txtCopies" ValidationGroup="AddGroup"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label">عدد العناوين *</label>
                                            <div class="controls">
                                                <input type="text" class="span6" id="txtTitles" runat="server" name="txtNoOfBooks" />
                                                <asp:RequiredFieldValidator ID="rfvtxtTitles" runat="server" ErrorMessage="يجب ادخال عدد العناوين " ControlToValidate="txtTitles" ValidationGroup="AddGroup"></asp:RequiredFieldValidator>
