<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="GeneralCollectionStat.aspx.cs" Inherits="Admin_GeneralCollectionStat" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        ...
        function printdiv(printpage) {
            var headstr = "<html><head><title></title></head><body><div style=\"margin:0 auto;\"><h1 style=\"text-align:center;\"><img src=\"img/KFNLLOGO.png\"/></h1><br /><br /><br /><h1 style=\"text-align:center;\">خدمة المستفيدين المجموعات العامة</h1>";
            var fromToDate = "";
                    ...
                    <div id="div_print">
                        <table class="table table-striped table-bordered table-advance table-hover textTable">
                            ...
                            <tr>
                                    ...
                                    <th class="borderLeft"><i class="fa fa-file"></i>&nbsp;عدد الكتب المستخرجة</th>
