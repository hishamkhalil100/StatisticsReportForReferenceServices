<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="OrignizationAndSortingStat.aspx.cs" Inherits="Admin_OrignizationAndSortingStat" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        ...
        function printdiv(printpage) {
            var headstr = "<html><head><title></title></head><body><div style=\"margin:0 auto;\"><h1 style=\"text-align:center;\"><img src=\"img/KFNLLOGO.png\"/></h1><br /><br /><br /><h1 style=\"text-align:center;\">وحدة الفرز والتنظيم</h1>";
            var fromToDate = "";
                    ...
                    <div id="div_print">
                        <table class="table table-striped table-bordered table-advance table-hover textTable">
                            ...
                            <tr>
                                    ...
                                    <th class="borderLeft"><i class="fa fa-file"></i>&nbsp;إعادة الفهرسة </th>
                                    <th class="borderLeft"><i class="fa fa-file"></i>&nbsp;إعادة التكعيب </th>
                                    <th class="borderLeft"><i class="fa fa-window-maximize"></i>&nbsp;التجليد</th>
                                    <th class="borderLeft"><i class="fa fa-window-maximize"></i>&nbsp;إستبعاد</th>
                            ...
                            <tbody>
                                <tr>
                                    <td class="borderLeft">
                                        ...
                                        <asp:Label ID="lblReindex" runat="server" />
                                    </td>
                                    <td class=" borderLeft">
                                        <asp:Label ID="lblRelabel" runat="server" />
                                    </td>
                                    <td class=" borderLeft">
                                        <asp:Label ID="lblBinding" runat="server" />
                                    </td> 
                                    <td class=" borderLeft">
                                        <asp:Label ID="lblExclude" runat="server" />
                                    </td>
