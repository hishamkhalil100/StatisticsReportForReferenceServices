...
(function($){
  $.fn.downCount = function(options, callback){
    ...
    function countdown(){
        var target_date = new Date(2018, 3, 18, 13, 5, 5, 5),
      ...
      var days    = Math.floor(difference /_day),
        ...
        var ref_days = (days === "001" || days === "01") ? '\u064A\u0648\u0645' : '\u0627\u064A\u0627\u0645',
          ref_hours = (hours === "01") ? '\u0633\u0627\u0639\u0629' : '\u0633\u0627\u0639\u0629',
          ref_minutes = (minutes === "01") ? '\u062F\u0642\u064A\u0642\u0629' : '\u062F\u0642\u064A\u0642\u0629',
          ref_seconds = (seconds === "01") ? '\u062B\u0627\u0646\u064A\u0629' : '\u062B\u0627\u0646\u064A\u0629';
